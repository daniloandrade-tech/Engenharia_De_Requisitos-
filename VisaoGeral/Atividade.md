...
**Resolução**
1. Diretória; Coordenação;
2. Registrar alunos;  Consultar registros de Entrada e saída; Associe o fluxo de entrada e saída à lista de presença dos alunos;
3. Compatibilidade Multiplataforma; Executar o sistema offline;
4. É importante levantar os requisitos antes de desenvolver o software para evitar desenvolver um sistema que o cliente não pediu e haver perda de investimento e 
